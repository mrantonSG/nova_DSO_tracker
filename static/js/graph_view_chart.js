    ...
    try {
        ...
        if (data.weather_forecast && data.weather_forecast.length > 0) {
            data.weather_forecast.forEach((block, index) => {
                // MODIFIED: Weather bands moved back to their original positions
